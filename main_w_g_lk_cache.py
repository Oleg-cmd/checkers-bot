...
class CheckersAI:
    ...
    def minimax(self, board, depth, alpha, beta, maximizing_player):
        ...
        # adding kings
        possible_moves.extend(self.get_possible_moves(board, color + "K"))
    ...
    def get_best_move(self, board):
        ...
        # adding logic to kings

        possible_moves.extend(self.get_possible_moves(board, self.player_color + "K"))
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    if board[new_row][new_col] == "_":
                        ...
                        possible_moves.extend(ai.get_possible_moves(board, "BK"))
